...
class CharacterController extends FlareControls {
  ...
  bool advance(FlutterActorArtboard artboard, double elapsed) {
    ...
    if (_hasFocus) {
      ...
      final Vec2D toCaret = Vec2D.subtract(Vec2D(), _caretWorld, _faceOrigin);
      ...
      final Mat2D toFaceTransform = Mat2D();
    ...
    final Vec2D frameTranslation = Vec2D.add(Vec2D(), _faceControl.translation,
